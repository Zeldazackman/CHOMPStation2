...
/mob/living/simple_mob
	...
	var/vore_bump_chance = 15			// Chance of trying to eat anyone that bumps into them, regardless of hostility
	var/vore_bump_emote	= "grabs hold of"				// Allow messages for bumpnom mobs to have a flavorful bumpnom
	var/vore_pounce_chance = 10			// Chance of this mob knocking down an opponent
	...
	var/vore_default_flags = 12			// No flags
	...
	var/vore_escape_chance = 15			// Chance of resisting out of mob
